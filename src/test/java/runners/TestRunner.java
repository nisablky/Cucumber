...
@CucumberOptions(
        plugin = {"html:target/cucumberr-reports.html",
...
public class TestRunner {
    ...
    Bu notasyon icin Cucumber framework'umuzde JUnit kullanmayi tercih ediyoruz

    features : Runner dosyasinin feature dosyalarini nereden bulacagini tarif eder
    glue : stepp definitions dosylarini nerede bulacagimizi gosterir
