...
public class AmazonStepDefinitions {
    ...
    public void urlInIcerdiginiTestEder(String istenenUrl) {
    ...
    public void kullaniciAnasayfasinda(String istenenKelime) {
        Driver.getDriver().get(ConfigReader.getProperty(istenenKelime));
    }
