...
public class Hooks {
    /*
    Cucumber'da step definitons package'i icerisinde
    @before, @after gibi bir notasyon varsa
     extend testBase dememize gerek kalmadan
     ...
     biz her senaryodan sonra kontrol edip
     failed olan scenario'lar icin
     screenshoot olmasi amaciyla
