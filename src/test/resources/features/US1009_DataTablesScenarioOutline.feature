Feature: US1009 datattables sitesine 5 farkli giris yapilamaz
  @data
  Scenario Outline:  TC14 kullanici 5 farkli kayit girisi yapabilmeli
    ...
    Examples:
      ...
      |Berk     |Can     |tester  |ankara|api      |20022-05-05|11000 |
      |Huseyin  |Kacmaz  |BA      |berlin|-        |20022-07-10|40000 |
      |Fatih    |Sahin   |PO      |berlin|-        |20022-03-12|45000 |
      |Ahmet    |Kaya    |Tester  |ankara|database |20022-06-06|11000 |
